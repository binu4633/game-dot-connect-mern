...
const cpuGameSlice = createSlice({
    name:'cpuGame',
    initialState,
    reducers:{
...
export const {createBlocks,createCircle,updateBlocks,updateCircle,addBlockNums} = cpuGameSlice.actions;

export default cpuGameSlice.reducer;
